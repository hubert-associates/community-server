...
describe('A SetupHttpHandler', (): void => {
  ...
  beforeEach(async(): Promise<void> => {
    request = { url: '/exactUriIsIrrelevant', method: 'GET', headers: {}} as any;
    requestBody = {};
  ...
  it('captures all requests while enabled.', async(): Promise<void> => {
  ...
  it('simply disables the handler if no setup is requested.', async(): Promise<void> => {
    ...
    await expect(handler.canHandle()).rejects.toThrow('Setup is finished.');
  });
